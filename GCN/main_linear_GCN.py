...
import cross_val
from models_GCN_linear import GCN
...
def evaluate(dataset, model_GCN, args, name='Test', max_num_examples=None):
    ...
    for batch_idx, data in enumerate(dataset):
        ...
        ypred = model_GCN(features, CBT_subject, args.threshold)
...
def arg_parse():
    ...
    parser.add_argument('--dataset', type=str, default='LH_GSP',
                        help='Dataset')
    parser.add_argument('--fusion_method', type=str, default='linear',
                        help='Fusion Method')
